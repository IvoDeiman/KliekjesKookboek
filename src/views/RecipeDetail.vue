  ...
  <div class="container-details sm:px-3 xl:px-[144px]">
    <div class="lg:grid lg:grid-cols-3 lg:gap-4">
      <div class="mb-8 lg:col-span-2 rounded-md box-shadow">
        ...
        <h1 class="recipe-title capitalize">{{ title }}</h1>
        <h2 class="quote capitalize"><i>{{ description }}</i></h2>
      ...
      <div class="owner  mb-8 rounded-md box-shadow">
        ...
        <label class="owner-name capitalize">{{ owner }}</label>
        <hr class="owner-seperator">
        <p class="chef-info capitalize">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
      </div>
    </div>
      ...
      <div class="">
        <ol>
          <li v-for="ingredient in ingredients" :key="ingredient" class="" style="">
            <input type="checkbox" class="ingredient-checkbox"> <span class="capitalize">{{ ingredient.name }}</span> {{ ingredient.amount }} {{ ingredient.measurement }}
          </li>
        </ol>
      </div>
    </div>
    ...
    <div class="instructions box-shadow rounded-md mb-8">
      ...
      <div class="">
        <ol>
          ...
          <li class="instruction-step capitalize">{{ preparation }}</li>
        </ol>
      </div>
    </div>
  </div>
